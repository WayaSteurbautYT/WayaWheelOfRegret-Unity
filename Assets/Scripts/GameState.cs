...
public static class GameState
{
    ...
    {
        { GameMode.Classic, new GameModeData { name = "Classic", description = "One question, one fate", maxSpins = 1, icon = "Classic" } },
        { GameMode.Chaos, new GameModeData { name = "Chaos Chain", description = "6 spins of escalating doom", maxSpins = 6, icon = "Chaos" } },
        { GameMode.Fate, new GameModeData { name = "Wheel of Fate", description = "The wheel knows who you are", maxSpins = 6, icon = "Fate" } },
        { GameMode.Rapid, new GameModeData { name = "Rapid Fire", description = "Auto-spin madness", maxSpins = 6, icon = "Rapid" } }
    };

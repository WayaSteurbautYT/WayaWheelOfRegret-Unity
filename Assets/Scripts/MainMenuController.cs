...
public class MainMenuController : MonoBehaviour
{
    ...
    public float iconRotationSpeed = 30f;
    public float iconScaleAmount = 0.1f;
    ...
    private IEnumerator AnimateIcon()
    {
        ...
        while (true)
        {
            float rotation = Time.time * iconRotationSpeed;
            float scale = Mathf.Sin(Time.time * 2f) * iconScaleAmount + 1f;
